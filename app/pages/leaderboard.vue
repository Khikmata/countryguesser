...
<template>
  <div
    class="min-h-dvh bg-gradient-to-b from-sky-50 via-white to-orange-50/80 text-neutral-900 dark:from-neutral-950 dark:via-neutral-900 dark:to-orange-950/30 dark:text-white"
  >
