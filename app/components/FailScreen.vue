  ...
  <Transition name="fail-backdrop" appear>
    ...
    >
      <Transition name="fail-card" appear>
        ...
        >
          <p id="fail-title" class="text-center text-sm font-semibold uppercase tracking-widest text-rose-500">
            Run over
          </p>
          ...
          <p class="mt-3 text-center text-neutral-600 dark:text-neutral-300">
            The flag was
            <span class="font-semibold text-emerald-600 dark:text-emerald-400">{{ answerName }}</span>.
          </p>
          ...
          <dl class="mt-8 space-y-4 text-center">
            <div class="rounded-2xl bg-neutral-100 py-4 dark:bg-neutral-800/80">
              ...
              <dd class="mt-1 text-2xl font-bold tabular-nums text-neutral-900 dark:text-white">
                {{ guessedFlags }}<span class="text-neutral-400 dark:text-neutral-500"> / </span>{{ runTarget }}
              </dd>
            ...
            <div class="rounded-2xl bg-violet-500/10 py-4 dark:bg-violet-500/15">
              <dt class="text-xs font-medium uppercase tracking-wide text-violet-700 dark:text-violet-300">
                Final score
              </dt>
            ...
            <div class="rounded-2xl bg-amber-500/10 py-4 dark:bg-amber-500/15">
              <dt class="text-xs font-medium uppercase tracking-wide text-amber-800 dark:text-amber-200">
                Leaderboard
              </dt>
              <dd class="mt-1 text-lg font-bold text-amber-950 dark:text-amber-50">
                #{{ rank
                }}<span class="font-normal text-amber-800/80 dark:text-amber-200/90"> of {{ leaderboardTotal }}</span>
              </dd>
            </div>
          </dl>
